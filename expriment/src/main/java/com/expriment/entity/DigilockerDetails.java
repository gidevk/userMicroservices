...
public class DigilockerDetails {
    ...
    @Column(name = "digi_match_failed")
    private Boolean digiMatchFailed;

    @Column(name = "digi_rejection_reason")
    private String digiRejectionReason;
    ...
    public String getDigiRejectionReason() { return digiRejectionReason; }

    public void setDigiRejectionReason(String digiRejectionReason) { this.digiRejectionReason = digiRejectionReason; }
 ...
 public void setGender(String gender) {
  this.gender = gender;
    ...
    public Boolean getDigiMatchFailed() {
        return digiMatchFailed;
    }

    public void setDigiMatchFailed(Boolean digiMatchFailed) {
        this.digiMatchFailed = digiMatchFailed;
    }
}
